...
<template>
    <v-navigation-drawer
        v-model="model"
        class="course-create-drawer lesson-create-drawer"
        location="end"
        temporary
        width="480"
        scrim
        ...
        <v-container class="py-6" fluid>
            <v-form class="d-flex flex-column ga-4" @submit.prevent="submit">
                ...
                <v-text-field
                    ...
                    hide-details="auto"
                    hint="Leave empty to append at the end of the module"
                    label="Order"
                    persistent-hint
                    type="number"
                    variant="outlined"
...
<style>
.lesson-create-drawer.v-navigation-drawer--temporary {
...
.v-navigation-drawer.lesson-create-drawer ~ .v-navigation-drawer__scrim,
.v-navigation-drawer.lesson-create-drawer ~ * .v-navigation-drawer__scrim {
    position: fixed !important;
    inset: 0 !important;
